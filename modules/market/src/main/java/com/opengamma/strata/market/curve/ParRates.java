...
public final class ParRates implements ImmutableBean {
  ...
  // Hand-written constructor to allow wildcard on the rates parameter but not on the field
  @ImmutableConstructor
  private ParRates(Map<? extends ObservableId, Double> rates, CurveMetadata curveMetadata) {
    this.rates = ImmutableMap.copyOf(rates);
    this.curveMetadata = ArgChecker.notNull(curveMetadata, "curveMetadata");
  }
