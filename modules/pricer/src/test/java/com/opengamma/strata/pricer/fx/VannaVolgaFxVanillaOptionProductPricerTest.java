...
public class VannaVolgaFxVanillaOptionProductPricerTest {
  ...
  public void test_presentValueSensitivity() {
    for (int i = 0; i < NB_STRIKES; ++i) {
      ...
      PointSensitivityBuilder point = PRICER.presentValueSensitivity(option, RATES_PROVIDER, VOL_PROVIDER);
  ...
  public void test_presentValueSensitivity_afterExpiry() {
    for (int i = 0; i < NB_STRIKES; ++i) {
      PointSensitivityBuilder computedCall =
          PRICER.presentValueSensitivity(CALLS[i], RATES_PROVIDER_AFTER, VOL_PROVIDER_AFTER);
      assertEquals(computedCall, PointSensitivityBuilder.none());
      PointSensitivityBuilder computedPut =
          PRICER.presentValueSensitivity(PUTS[i], RATES_PROVIDER_AFTER, VOL_PROVIDER_AFTER);
  ...
  public void test_currencyExposure() {
    for (int i = 0; i < NB_STRIKES; ++i) {
      ...
      PointSensitivityBuilder pvSensiCall = PRICER.presentValueSensitivity(CALLS[i], RATES_PROVIDER, VOL_PROVIDER);
      ...
      PointSensitivityBuilder pvSensiPut = PRICER.presentValueSensitivity(PUTS[i], RATES_PROVIDER, VOL_PROVIDER);
  ...
  public void regression_test() {
    ...
    for (int i = 0; i < NB_STRIKES; ++i) {
      ...
      // curve sensitivity
      PointSensitivityBuilder point = PRICER.presentValueSensitivity(CALLS[i], RATES_PROVIDER, VOL_PROVIDER);
      CurveCurrencyParameterSensitivities sensiComputed = RATES_PROVIDER.curveParameterSensitivity(point.build());
