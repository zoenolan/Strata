 ...
 */
@Test
public class SabrSwaptionCalibrationUtilsCubeTest {
  ...
  private static final double TOLERANCE_PRICE_CALIBRATION_LS = 5.0E-5; // Calibration Least Square; result not exact
  ...
  public void normal_cube() {
    ...
    SabrParametersSwaptionVolatilities calibrated = SABR_CALIBRATION.calibrateFromNormalVolatilitiesFixedBetaShift(
        EUR_FIXED_1Y_EURIBOR_6M, CALIBRATION_TIME, ACT_365F, TENORS, DATA_SPARSE, MULTICURVE,
