 ...
 */
@Test
public class SabrSwaptionCalibrationUtilsCubeBlackTest {
  ...
  private static final DoubleArray MONEYNESS = 
      DoubleArray.ofUnsafe(new double[]{-0.0100, -0.0050, -0.0025, 0.0000, 0.0025, 0.0050, 0.0100, 0.0200});
  ...
  private static final Double[][][] DATA_LOGNORMAL_SPARSE = {
    ...
    {null, null, null, null, null, null, null, null },
    {null, null, null, null, null, null, null, null },
    {null, null, null, null, 1.4019, 1.0985, 0.8441, 0.6468 } },
    { {null, null, null, null, null, null, null, null },
    {null, null, null, null, null, null, null, null },
    {null, null, null, null, null, null, null, null },
    {null, null, null, null, null, null, null, null },
    {null, null, null, null, null, null, null, null },
    {null, 1.969, null, 1.2894, 1.0152, 0.8718, 0.7142, 0.5712 } },
    { {null, null, null, null, null, null, null, null },
    {null, null, null, null, null, null, null, null },
    {null, null, null, null, 6.2852, 4.2545, 2.5079, 1.8524 },
    {null, null, null, null, 4.0593, 2.2422, 1.5647, 1.2192 },
    {null, null, 3.1613, 2.8434, 1.5934, 1.2644, 0.9856, 0.7885 },
    {2.0291, 1.2216, 0.9355, 0.7936, 0.7047, 0.643, 0.5625, 0.4793 } },
    { {null, 6.6443, 1.8125, 1.3324, 1.1296, 1.0273, 0.9392, 0.8961 },
    {null, 4.3337, 1.6752, 1.2496, 1.0687, 0.9785, 0.9032, 0.8712 },
    {null, 3.2343, 1.5785, 1.2105, 1.0415, 0.9499, 0.8629, 0.8123 },
    {null, 2.3148, 1.3951, 1.1006, 0.9474, 0.8544, 0.751, 0.6684 },
    {null, 1.5092, 1.1069, 0.9209, 0.8095, 0.7348, 0.6416, 0.5518 },
    ...
    for (int looptenor = 0; looptenor < TENORS.size(); looptenor++) {
      ...
      for (int loopexpiry = 0; loopexpiry < EXPIRIES.size(); loopexpiry++) {
        ...
        for (int loopmoney = 0; loopmoney < MONEYNESS.size(); loopmoney++) {
          if (DATA_LOGNORMAL_SPARSE[looptenor][loopexpiry][loopmoney] != null) {
...
//                + ": " + priceComputed + " / " + priceLogNormal);
  ...
  private static List<RawOptionData> rawData(Double[][][] dataArray) {
    ...
    for (int looptenor = 0; looptenor < dataArray.length; looptenor++) {
      raw.add(RawOptionData.of(MONEYNESS, ValueType.SIMPLE_MONEYNESS, EXPIRIES, dataArray[looptenor], ValueType.BLACK_VOLATILITY));
    }
    return raw;
  }
