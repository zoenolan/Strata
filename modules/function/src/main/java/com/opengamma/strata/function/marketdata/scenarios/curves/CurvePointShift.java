 ...
 * <p>
 * A shift is not applied if there is no point on the curve with a matching identifier or if the
 * curve has no parameter metadata.
 *
...
public final class CurvePointShift implements Perturbation<Curve>, ImmutableBean {
  ...
  /**
   * Returns a new mutable builder for building instances of {@code ParRatesPointShift}.
   *
   * @param shiftType  the type of shift to apply to the rates
   * @return a new mutable builder for building instances of {@code ParRatesPointShift}
   */
